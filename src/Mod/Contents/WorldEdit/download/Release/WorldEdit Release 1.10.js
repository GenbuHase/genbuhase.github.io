...
function newLevel() {
	...
	try {
		CreateGUI(function() {
			SetOnPopUpWindow(0,
				AddButton(0, "WorldEdit", 10, Color.White, function() {
					XMax = Math.max(Location.X1, Location.X2);
					XMin = Math.min(Location.X1, Location.X2);
					YMax = Math.max(Location.Y1, Location.Y2);
					YMin = Math.min(Location.Y1, Location.Y2);
					...
					SetOnDialog(0, "WorldEdit メニュー",
						AddScrollView(0,
							AddLinearLayout(0, "Vertical",
								[
									AddButton(1, "Set", Size.Wrap, Color.White, function() {
										SetOnDialog(1, "WorldEdit == Set",
											AddLinearLayout(0, "Vertical",
												[
													AddTextView(0, "ブロックID:", Size.Wrap, Color.White, Align.Left, Align.Center, function(){}, function(){}),
													AddEditText(0, "", Color.Green, Color.Red),
												
													AddTextView(1, "ダメージ値:", Size.Wrap, Color.White, Align.Left, Align.Center, function(){}, function(){}),
													AddEditText(1, "", Color.Green, Color.Red),
									...
									AddButton(2, "Box", Size.Wrap, Color.White, function() {
									...
									AddButton(3, "Wall", Size.Wrap, Color.White, function() {
									...
									AddButton(4, "Ball", Size.Wrap, Color.White, function() {
										SetOnDialog(4, "WorldEdit == Ball",
											AddLinearLayout(0, "Vertical",
												[
													AddButton(11, "Shape", Size.Wrap, Color.White, function() {
														SetOnDialog(11, "WorldEdit == Ball(Shape)",
															AddLinearLayout(0, "Vertical",
																[
																	AddTextView(0, "半径:", Size.Wrap, Color.White, Align.Left, Align.Center, function(){}, function(){}),
																	AddEditText(0, "", Color.Green, Color.Red),
																
																	AddTextView(1, "ブロックID:", Size.Wrap, Color.White, Align.Left, Align.Center, function(){}, function(){}),
																	AddEditText(1, "", Color.Green, Color.Red),
																
																	AddTextView(2, "ダメージ値:", Size.Wrap, Color.White, Align.Left, Align.Center, function(){}, function(){}),
																	AddEditText(2, "", Color.Green, Color.Red),
																
																	AddButton(10, "確定", Size.Wrap, Color.Yellow, function() {
																		Ball_Shape(parseInt(EditTexts[0].getText()), parseInt(EditTexts[1].getText()), parseInt(EditTexts[2].getText()));
																	}, function() {
													...
													AddButton(12, "Fill", Size.Wrap, Color.White, function() {
									...
									AddButton(5, "Copy", Size.Wrap, Color.White, function() {
										Copy();
									}, function() {
									
									}),

									AddButton(6, "Cut", Size.Wrap, Color.White, function() {
										Cut();
									}, function() {
									
									}),

									AddButton(7, "Paste", Size.Wrap, Color.White, function() {
										Paste();
									}, function() {
...
function Area1() {
	Location.X1 = Math.round(Player.getX());
	Location.Y1 = Math.round(Player.getY() - 2);
	Location.Z1 = Math.round(Player.getZ());
...
function Area2() {
	Location.X2 = Math.round(Player.getX());
	Location.Y2 = Math.round(Player.getY() - 2);
	Location.Z2 = Math.round(Player.getZ());
...
function Ball_Shape(Range, BlockID, BlockData) {
	if (Range == undefined) {
...
function Copy() {
	if (Location.X1 == undefined) {
		...
		try {
			if(java.io.File(Directory.Dir).exists() == false) {
				java.io.File(Directory.Dir).mkdirs();
				java.io.File(Directory.Dir + "/Save").mkdirs();
			} else if(java.io.File(Directory.Dir + "/Save").exists() == false) {
				java.io.File(Directory.Dir + "/Save").mkdirs();
			}
					
			var StateFile = new java.io.BufferedWriter(new java.io.FileWriter(new java.io.File(Directory.Dir + "/Save/BlockState.sav"), false));
...
function Paste() {
	new java.lang.Thread(function() {
		try {
			if (java.io.File(Directory.Dir + "/Save/BlockState.sav").exists() == false) {
				clientMessage("コピーされていません");
			} else {
				var StateFile = new java.io.BufferedReader(new java.io.FileReader(new java.io.File(Directory.Dir + "/Save/BlockState.sav")));
