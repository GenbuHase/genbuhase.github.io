...
function procCmd(Cmd) {
	...
	switch (Cmd[0]) {
		...
		case "/circle":
			Circle(Cmd[1], Cmd[2] ,Cmd[3]);
			break;
			
		case "/ball":
			Ball(Cmd[1], Cmd[2], Cmd[3], Cmd[4]);
			break;
...
function modTick() {
	if (Location.X1 == undefined || Location.X2 == undefined || Location.Y1 == undefined || Location.Y2 == undefined || Location.Z1 == undefined || Location.Z2 == undefined) {
		Timer = 0;
	} else {
		if (Timer >= 20) {
			for (var Y = 0, X = 0, Z = 0, Height = 0; Y == YMax - YMin, X == XMax - XMin, Z == ZMax - ZMin, Height = YMax - YMin; Y++, X++, Z++, Height += 0.25) {
				if (Height == 0 || Height == YMax - YMin) {
					Level.addParticle(ParticleType.flame, XMin + X, YMin + Height + Y, ZMin, 0, 0, 0, 0);
					Level.addParticle(ParticleType.flame, XMin + 0.25 + X, YMin + Height + Y, ZMin, 0, 0, 0, 0);
					Level.addParticle(ParticleType.flame, XMin + 0.5 + X, YMin + Height + Y, ZMin, 0, 0, 0, 0);
					Level.addParticle(ParticleType.flame, XMin + 0.75 + X, YMin + Height + Y, ZMin, 0, 0, 0, 0);
					Level.addParticle(ParticleType.flame, XMin + 1 + X, YMin + Height + Y, ZMin, 0, 0, 0, 0);
					//
					Level.addParticle(ParticleType.flame, XMin + X, YMin + Height + Y, ZMin + 1 + Z, 0, 0, 0, 0);
					Level.addParticle(ParticleType.flame, XMin + 0.25 + X, YMin + Height + Y, ZMin + 1 + Z, 0, 0, 0, 0);
					Level.addParticle(ParticleType.flame, XMin + 0.5 + X, YMin + Height + Y, ZMin + 1 + Z, 0, 0, 0, 0);
					Level.addParticle(ParticleType.flame, XMin + 0.75 + X, YMin + Height + Y, ZMin + 1 + Z, 0, 0, 0, 0);
					Level.addParticle(ParticleType.flame, XMin + 1 + X, YMin + Height + Y, ZMin + 1 + Z, 0, 0, 0, 0);
					//
					Level.addParticle(ParticleType.flame, XMin + X, YMin + Height + Y, ZMin + Z, 0, 0, 0, 0);
					Level.addParticle(ParticleType.flame, XMin + X, YMin + Height + Y, ZMin + 0.25 + Z, 0, 0, 0, 0);
					Level.addParticle(ParticleType.flame, XMin + X, YMin + Height + Y, ZMin + 0.5 + Z, 0, 0, 0, 0);
					Level.addParticle(ParticleType.flame, XMin + X, YMin + Height + Y, ZMin + 0.75 + Z, 0, 0, 0, 0);
					Level.addParticle(ParticleType.flame, XMin + X, YMin + Height + Y, ZMin + 1 + Z, 0, 0, 0, 0);
					//
					Level.addParticle(ParticleType.flame, XMin + 1 + X, YMin + Height + Y, ZMin + Z, 0, 0, 0, 0);
					Level.addParticle(ParticleType.flame, XMin + 1 + X, YMin + Height + Y, ZMin + 0.25 + Z, 0, 0, 0, 0);
					Level.addParticle(ParticleType.flame, XMin + 1 + X, YMin + Height + Y, ZMin + 0.5 + Z, 0, 0, 0, 0);
					Level.addParticle(ParticleType.flame, XMin + 1 + X, YMin + Height + Y, ZMin + 0.75 + Z, 0, 0, 0, 0);
					Level.addParticle(ParticleType.flame, XMin + 1 + X, YMin + Height + Y, ZMin + 1 + Z, 0, 0, 0, 0);
				} else if (Y > 0 && Y < YMax - YMin) {
					Level.addParticle(ParticleType.flame, XMin + X, YMin + Height + Y, ZMin + Z, 0, 0, 0, 0);
					Level.addParticle(ParticleType.flame, XMin + 1 + X, YMin + Height + Y, ZMin + Z, 0, 0, 0, 0);
...
function Set(BlockID, BlockData) {
	if (Location.X1 == undefined) {
		...
		for (var Y = 0; Y <= (YMax - YMin) + 1; Y += 0.25) {
			if (Y == 0 || Y == YMax - YMin) {
				Level.addParticle(ParticleType.flame, XMin, YMin + Y, ZMin, 0, 0, 0, 0);
				Level.addParticle(ParticleType.flame, XMin + 0.25, YMin + Y, ZMin, 0, 0, 0, 0);
				Level.addParticle(ParticleType.flame, XMin + 0.5, YMin + Y, ZMin, 0, 0, 0, 0);
				Level.addParticle(ParticleType.flame, XMin + 0.75, YMin + Y, ZMin, 0, 0, 0, 0);
				Level.addParticle(ParticleType.flame, XMin + 1, YMin + Y, ZMin, 0, 0, 0, 0);

				Level.addParticle(ParticleType.flame, XMin, YMin + Y, ZMin + 1, 0, 0, 0, 0);
				Level.addParticle(ParticleType.flame, XMin + 0.25, YMin + Y, ZMin + 1, 0, 0, 0, 0);
				Level.addParticle(ParticleType.flame, XMin + 0.5, YMin + Y, ZMin + 1, 0, 0, 0, 0);
				Level.addParticle(ParticleType.flame, XMin + 0.7, YMin + Y, ZMin + 1, 0, 0, 0, 0);
				Level.addParticle(ParticleType.flame, XMin + 1, YMin + Y, ZMin + 1, 0, 0, 0, 0);

				Level.addParticle(ParticleType.flame, XMin, YMin + Y, ZMin, 0, 0, 0, 0);
				Level.addParticle(ParticleType.flame, XMin, YMin + Y, ZMin + 0.25, 0, 0, 0, 0);
				Level.addParticle(ParticleType.flame, XMin, YMin + Y, ZMin + 0.5, 0, 0, 0, 0);
				Level.addParticle(ParticleType.flame, XMin, YMin + Y, ZMin + 0.75, 0, 0, 0, 0);
				Level.addParticle(ParticleType.flame, XMin, YMin + Y, ZMin + 1, 0, 0, 0, 0);

				Level.addParticle(ParticleType.flame, XMin + 1, YMin + Y, ZMin, 0, 0, 0, 0);
				Level.addParticle(ParticleType.flame, XMin + 1, YMin + Y, ZMin + 0.25, 0, 0, 0, 0);
				Level.addParticle(ParticleType.flame, XMin + 1, YMin + Y, ZMin + 0.5, 0, 0, 0, 0);
				Level.addParticle(ParticleType.flame, XMin + 1, YMin + Y, ZMin + 0.75, 0, 0, 0, 0);
				Level.addParticle(ParticleType.flame, XMin + 1, YMin + Y, ZMin + 1, 0, 0, 0, 0);
			} else if (Y > 0 && Y < YMax - YMin) {
				Level.addParticle(ParticleType.flame, XMin, YMin + Y, ZMin, 0, 0, 0, 0);
				Level.addParticle(ParticleType.flame, XMin + 1, YMin + Y, ZMin, 0, 0, 0, 0);
...
function Box(BlockID, BlockData) {
	if (Location.X1 == undefined) {
		...
		for (var X = 1; X <= XMax - XMin - 1; X++) {
			for (var Y = 1; Y <= YMax - YMin - 1; Y++) {
				for (var Z = 1; Z <= ZMax - ZMin - 1; Z++) {
