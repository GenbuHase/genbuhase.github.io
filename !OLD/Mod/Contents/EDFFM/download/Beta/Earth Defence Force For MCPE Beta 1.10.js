...
function ShowGun() {
	CreateGUI(function() {
		...
		AddButton(1, "Reload", 10, Color.WHITE, function() {
			switch(getCarriedItem()) {
				case Ranger.AR.AF14:
					if(Param.Ranger.AR.AF14.Bullet != 120 && !Flag.IsReloading) {
						AddTextView(2, "RELOAD", 24, Color.RED, Align.CENTER, Align.CENTER, function(){}, function(){}, 800, 400, Align.CENTER, Align.CENTER, 0, -100);
						AddProgressBar(3, 0, 100, "Horizontal", 600, 300, Align.CENTER, Align.CENTER, 0, 0);
				...
				case Ranger.AR.AF14RA:
					if(Param.Ranger.AR.AF14RA.Bullet != 200 && !Flag.IsReloading) {
						AddTextView(2, "RELOAD", 24, Color.RED, Align.CENTER, Align.CENTER, function(){}, function(){}, 800, 400, Align.CENTER, Align.CENTER, 0, -100);
						AddProgressBar(3, 0, 100, "Horizontal", 600, 300, Align.CENTER, Align.CENTER, 0, 0);
						Flag.IsReloading = true;
