/*/
 *#######################################################
 *Villager's Inventory Release 1.4
					...
					with (GUIHelper.Set) {
						with (GUIHelper.Property) {
							...
							CreateGUI(function () {
								...
								for (var i = 0; i < Villagers.length; i++) {
									if (Villagers[i]["UUID"] == Victim) {
										var ItemImg = net.zhuoweizhang.mcpelauncher.texture.tga.TGALoader.load(ModPE.openInputStreamFromTexturePack("images/items-opaque.tga"), false);
										...
										Items[0] = Villagers[i]["Inventory"][0]["ID"] > 255 ? 
											AddImageView(0, "Bitmap", android.graphics.Bitmap.createBitmap(ItemImg, Item.getTextureCoords(Villagers[i]["Inventory"][0]["ID"], Villagers[i]["Inventory"][0]["Damage"])[0], Item.getTextureCoords(Villagers[i]["Inventory"][0]["ID"], Villagers[i]["Inventory"][0]["Damage"])[1], 16, 16, M, true), ScaleType.Normal) : 
											AddImageView(0, "Base64", Images.Slot, ScaleType.Normal);

										Items[1] = Villagers[i]["Inventory"][1]["ID"] > 255 ? 
											AddImageView(1, "Bitmap", android.graphics.Bitmap.createBitmap(ItemImg, Item.getTextureCoords(Villagers[i]["Inventory"][1]["ID"], Villagers[i]["Inventory"][1]["Damage"])[0], Item.getTextureCoords(Villagers[i]["Inventory"][1]["ID"], Villagers[i]["Inventory"][1]["Damage"])[1], 16, 16, M, true), ScaleType.Normal) : 
											AddImageView(1, "Base64", Images.Slot, ScaleType.Normal);

										Items[2] = Villagers[i]["Inventory"][2]["ID"] > 255 ? 
											AddImageView(2, "Bitmap", android.graphics.Bitmap.createBitmap(ItemImg, Item.getTextureCoords(Villagers[i]["Inventory"][2]["ID"], Villagers[i]["Inventory"][2]["Damage"])[0], Item.getTextureCoords(Villagers[i]["Inventory"][2]["ID"], Villagers[i]["Inventory"][2]["Damage"])[1], 16, 16, M, true), ScaleType.Normal) : 
											AddImageView(2, "Base64", Images.Slot, ScaleType.Normal);

										Items[3] = Villagers[i]["Inventory"][3]["ID"] > 255 ? 
											AddImageView(3, "Bitmap", android.graphics.Bitmap.createBitmap(ItemImg, Item.getTextureCoords(Villagers[i]["Inventory"][3]["ID"], Villagers[i]["Inventory"][3]["Damage"])[0], Item.getTextureCoords(Villagers[i]["Inventory"][3]["ID"], Villagers[i]["Inventory"][3]["Damage"])[1], 16, 16, M, true), ScaleType.Normal) : 
											AddImageView(3, "Base64", Images.Slot, ScaleType.Normal);

										Items[4] = Villagers[i]["Inventory"][4]["ID"] > 255 ? 
											AddImageView(4, "Bitmap", android.graphics.Bitmap.createBitmap(ItemImg, Item.getTextureCoords(Villagers[i]["Inventory"][4]["ID"], Villagers[i]["Inventory"][4]["Damage"])[0], Item.getTextureCoords(Villagers[i]["Inventory"][4]["ID"], Villagers[i]["Inventory"][4]["Damage"])[1], 16, 16, M, true), ScaleType.Normal) : 
											AddImageView(4, "Base64", Images.Slot, ScaleType.Normal);
