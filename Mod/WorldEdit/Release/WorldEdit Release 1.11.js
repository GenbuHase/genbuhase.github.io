...
function newLevel() {
	...
	try {
		CreateGUI(function() {
			SetOnPopUpWindow(0,
				AddButton(0, "WorldEdit", 10, Color.Green, function() {
					...
					SetOnDialog(0, "WorldEdit メニュー",
						AddScrollView(0,
							AddLinearLayout(0, "Vertical",
								[
									AddButton(1, "Set", Size.Wrap, Color.Green, function() {
										SetOnDialog(1, "WorldEdit == Set",
											AddLinearLayout(0, "Vertical",
												[
													AddTextView(0, "ブロックID:", Size.Wrap, Color.Green, Align.Left, Align.Center, function(){}, function(){}),
													AddEditText(0, "", Color.Green, Color.Red),
												
													AddTextView(1, "ダメージ値:", Size.Wrap, Color.Green, Align.Left, Align.Center, function(){}, function(){}),
									...
									AddButton(2, "Box", Size.Wrap, Color.Green, function() {
									...
									AddButton(3, "Wall", Size.Wrap, Color.Green, function() {
									...
									AddButton(4, "Circle", Size.Wrap, Color.Green, function() {
										SetOnDialog(4, "WorldEdit == Circle",
											AddLinearLayout(0, "Vertical",
												[
													AddTextView(0, "半径:", Size.Wrap, Color.Green, Align.Left, Align.Center, function(){}, function(){}),
													AddEditText(0, "", Color.Green, Color.Red),
													
													AddTextView(1, "高さ:", Size.Wrap, Color.Green, Align.Left, Align.Center, function(){}, function(){}),
													AddEditText(1, "", Color.Green, Color.Red),
													
													AddTextView(2, "ブロックID:", Size.Wrap, Color.Green, Align.Left, Align.Center, function(){}, function(){}),
													AddEditText(2, "", Color.Green, Color.Red),
													
													AddTextView(3, "ダメージ値:", Size.Wrap, Color.Green, Align.Left, Align.Center, function(){}, function(){}),
													AddEditText(3, "", Color.Green, Color.Red),
									...
									AddButton(5, "Ball", Size.Wrap, Color.Green, function() {
										SetOnDialog(5, "WorldEdit == Ball",
											AddLinearLayout(0, "Vertical",
												[
													AddButton(11, "Shape", Size.Wrap, Color.Green, function() {
														SetOnDialog(11, "WorldEdit == Ball(Shape)",
															AddLinearLayout(0, "Vertical",
																[
																	...
																	AddTextView(1, "ブロックID:", Size.Wrap, Color.Green, Align.Left, Align.Center, function(){}, function(){}),
																	AddEditText(1, "", Color.Green, Color.Red),
																
																	AddTextView(2, "ダメージ値:", Size.Wrap, Color.Green, Align.Left, Align.Center, function(){}, function(){}),
																	AddEditText(2, "", Color.Green, Color.Red),
													...
													AddButton(12, "Fill", Size.Wrap, Color.Green, function() {
									...
									AddButton(6, "Pyramid", Size.Wrap, Color.Green, function() {
									...
									AddButton(7, "Copy", Size.Wrap, Color.Green, function() {
										Copy();
									}, function() {
									
									}),

									AddButton(8, "Cut", Size.Wrap, Color.Green, function() {
										Cut();
									}, function() {
									
									}),

									AddButton(9, "Paste", Size.Wrap, Color.Green, function() {
										Paste();
									}, function() {
